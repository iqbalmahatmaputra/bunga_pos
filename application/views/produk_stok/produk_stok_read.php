                ...
                <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                    ...
                    <div class="navi-item mb-2">
                        <a href="custom/apps/profile/profile-1/change-password.html" class="navi-link py-4 ">
                            ...
                            <span class="navi-label">
                                <span
                                    class="label label-light-primary label-rounded"><?=$stok->jumlah_produk_stok + $jum_retur?></span>
                            </span>
                        </a>
                    </div>
                    <div class="navi-item mb-2">
                    ...
                    <div class="navi-item mb-2">
                        <a href="custom/apps/profile/profile-1/change-password.html" class="navi-link py-4 ">
                            ...
                            <span class="navi-label">
                                <span class="label label-light-warning label-rounded font-weight-bold"><?=
$jum_retur
?></span>
                            </span>
                        </a>
...
(empty($penjualan_total->qty)) ? $stok->jumlah_produk_stok - 0 + $jum_retur : $stok->jumlah_produk_stok - $penjualan_total->qty + $jum_retur
?></span>
                            </span>
                        </a>
                    </div>
...
foreach ($penjualan as $key => $value) {
    ...
    ?></td>
            ...
            <div class="card-header border-0 py-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label font-weight-bolder text-dark">History Retur Produk</span>
...
foreach ($retur as $key => $value) {
    ?>
                                <tr>
                                    ...
                                    <td> <?=date('d F Y h:m:s', strtotime($value->tanggal_retur));
    ?></td> 
     <td> <?= "QG-".$value->no_faktur;    ?></td> 
                                    <td> <?=$value->qty?></td>

                ...
                <div class="col-md-9">
                    ...
                    <div class="d-flex justify-content-between pt-6">
                        <div class="d-flex flex-column flex-root">
                            ...
                            <span class="opacity-70"><?php echo $penjualan->tanggal_penjualan; ?></span>
                        </div>
                        <div class=" d-flex flex-column flex-root">
                    ...
                    <div id="sub_isi">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3"> <input class="form-control" type="text" name="harga[]" id="harga"
                                    value="<?=$value->total_harga;?>" readonly>
                            </div>
                            <div class="col-md-3"> <input class="form-control" type="text" name="total" id="total"
                                    value="<?=$value->total_harga * $value->qty;?>" readonly>
                            </div>
...
?>
            ...
            <div class="row bg-gray">
                ...
                <div class="col-md-6">
                    <h4>Total Penjualan : <a id="total_akhir"><?=$total;?></a></h4>
                </div>
            </div>
            <!-- end: Invoice footer-->

...
<div class="card card-custom overflow-hidden">
	<div class="card-body p-0">
		<form action="<?php echo base_url('produk_retur/selesai') ?>" method="POST">
				...
				<div class="col-md-12">
					...
					<div class="d-flex justify-content-between pt-6">
                        ...
                        <div class=" d-flex flex-column flex-root">
                            ...
                            <input type="text" class="form-control" name="tujuan" id="tujuan" value="<?= $penjualan->tujuan; ?>" readonly/>
						</div>
						<div class="d-flex flex-column flex-root">
							<span class="font-weight-bolder mb-2">Pencatat Invoice</span>
							<span class="opacity-70">
                            <input type="text" class="form-control" name="nama_user" id="nama_user" value="<?= $penjualan->nama_user; ?>" readonly/>
							</span>
						</div>
					</div>
				</div>
...
<script>
	...
	$(document).ready(function () {
		...
		$("#add").click(function () {
			$.ajax({
				url: "<?php echo base_url('produk/list_produk_retur/' . $penjualan->no_faktur) ?>",
		...
		$(document).off('change').on('change', '.cam_select', function (e) {
			...
			$(e.target).closest('#sub_isi').find('#info_stok').html("Jumlah yang Terjual : " + stok);

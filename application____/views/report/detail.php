                ...
                <div class="d-flex align-items-center justify-content-between flex-wrap">
                    <div class="mr-3">
                        ...
                        <a href="#" class="d-flex align-items-center text-dark text-hover-primary font-size-h5 font-weight-bold mr-3">
                            <?= $produk->kode_produk ?> - <?= $produk->nama_produk ?> <i class="flaticon2-correct text-success icon-md ml-2"></i>
                        </a>
                        <!--end::Name-->
        ...
        <div class="d-flex align-items-center flex-wrap">
            ...
            <div class="d-flex align-items-center flex-lg-fill mr-5 my-1">
                ...
                <div class="d-flex flex-column text-dark-75">
                    <span class="font-weight-bolder font-size-sm">Pendapatan</span>
                    <span class="font-weight-bolder font-size-h5"><span class="text-dark-50 font-weight-bold">Rp</span>249,500</span>
                </div>
            </div>
            <!--end: Item-->
            ...
            <div class="d-flex align-items-center flex-lg-fill mr-5 my-1">
                ...
                <div class="d-flex flex-column text-dark-75">
                    <span class="font-weight-bolder font-size-sm">Terjual</span>
                    <span class="font-weight-bolder font-size-h5"><span class="text-dark-50 font-weight-bold"></span><?= $jumTerjual; ?></span>
                </div>
            </div>
            <!--end: Item-->
            ...
            <div class="d-flex align-items-center flex-lg-fill mr-5 my-1">
                ...
                <div class="d-flex flex-column text-dark-75">
                    <span class="font-weight-bolder font-size-sm">Keseluruhan</span>
                    <span class="font-weight-bolder font-size-h5"><span class="text-dark-50 font-weight-bold">Rp</span>782,300</span>
                </div>
            </div>
            <!--end: Item-->
            ...
            <div class="d-flex align-items-center flex-lg-fill mr-5 my-1">
                ...
                <span class="font-weight-bolder font-size-sm">Sisa Stok</span>
                    <span class="text-dark-75 font-weight-bolder font-size-sm">73 buah</span>
                </div>
            </div>
            <!--end: Item-->

...
<div class="card-body">
<form action="<?= base_url('report/cekInven'); ?>" method="GET">
		<div class="row">
			<div class="col-md-3">
	...
	<div class="row">
		...
		?>
										<tr>
											...
											<td style="text-align: center;"><?php echo $u->tanggal_produk_stok ?></td>
											<td style="text-align: center;"><?php echo $u->jumlah_produk_stok ?></td>
											
											<td style="text-align: center;"><?php echo 
											number_format($u->harga_beli_produk , 0, ".", ".") ?></td>
											<td style="text-align: center;"><?php echo number_format($u->harga_jual_produk , 0, ".", ".")?></td>
											<td style="text-align: center;"><?php echo  
										 number_format($u->harga_jual_produk-$u->harga_beli_produk , 0, ".", ".")	?></td>
